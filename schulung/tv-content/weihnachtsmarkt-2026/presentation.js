(function (global) {
  ...
  const MEMBER_PROFILES = [
    { name: "Frank Brösel", photo: MEMBER_ASSET_BASE + "mitglied-01.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Hans-Joachim Koch", photo: MEMBER_ASSET_BASE + "mitglied-02.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Dieter Zander", photo: MEMBER_ASSET_BASE + "mitglied-03.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Andrea Spahn", photo: MEMBER_ASSET_BASE + "mitglied-04.jpg", mediaType: "image/jpeg", provisional: true },
    ...
    { name: "Karla Kazik", photo: MEMBER_ASSET_BASE + "mitglied-07.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Wilfried Wittwer", photo: MEMBER_ASSET_BASE + "mitglied-08.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Anne Reinkober", photo: MEMBER_ASSET_BASE + "mitglied-09.jpg", mediaType: "image/jpeg", provisional: true },
    { name: "Manfred Schoppmann", photo: MEMBER_ASSET_BASE + "mitglied-10.jpg", mediaType: "image/jpeg", provisional: true },
  ...
  const BACKGROUNDS = Object.freeze({
    ...
    "kerzen-tannenzweige": { label: "Kerzen und Tannenzweige", kind: "image", value: "../media/backgrounds/kerzen-tannenzweige.webp" },
    "tannenbaum-rot": { label: "Tannenbaum mit Geschenken", kind: "image", value: "../media/backgrounds/tannenbaum-rot.webp" },
    "lichterbaum-rot": { label: "Lichterbaum auf Rot", kind: "image", value: "../media/backgrounds/lichterbaum-rot.webp" },
    "linienbaum-bokeh": { label: "Linienbaum mit Lichtpunkten", kind: "image", value: "../media/backgrounds/linienbaum-bokeh.webp" },
  ...
  function catalogTable(items, rows, options = {}) {
    return {
      ...
      tableObject: {
        ...
        headerBg: "rgba(111,20,32,.92)",
        headerText: "#fff4dc",
        bodyBg: "rgba(255,250,240,.68)",
        bodyText: "#2d1719",
        border: "#c99b68"
      }
    };
  ...
  const FOOD_ITEMS = [
    ...
    // Preise am 03.09.2026 auf die Artikelstammdaten der Kasse gezogen (Betreiber): Hering 4,50,
    // Kartoffelcreme 3,50. Die beiden Knirpse-Artikel sind aus dem Sortiment genommen.
  ...
  function slides() {
    ...
    list.push(
      base(20, { title: "Gemeinsam aktiv für Kochkunst und Gemeinschaft", text: "› Regelmäßige Treffen\n› Fachlicher Austausch\n› Nachwuchsförderung\n› Ausflüge zu Lebensmittelbetrieben\n› Spenden und Aktionen für soziale Zwecke", bulletStyle: "arrow", duration: 14, decorations: ["👨‍🍳", "❤️"] }),
      ...
      base(23, { title: "Bühnenprogramm heute und morgen", text: "Heute\n› 00:00 Uhr · Programmpunkt ergänzen\n› 00:00 Uhr · Programmpunkt ergänzen\n\nMorgen\n› 00:00 Uhr · Programmpunkt ergänzen\n› 00:00 Uhr · Programmpunkt ergänzen", bulletStyle: "arrow", programView: "list", duration: 16, decorations: ["🎶", "⭐"] }),
      ...
      }, catalogTable(ALCOHOLIC_ITEMS, tableRows(ALCOHOLIC_ITEMS, "Getränk"), { key:"drinks-alcoholic", title:"Getränke", h:52, y:50, fontSize:18 }))),
      ...
      }, catalogTable(NON_ALCOHOLIC_ITEMS, tableRows(NON_ALCOHOLIC_ITEMS, "Getränk"), { key:"drinks-non-alcoholic", title:"Alkoholfreie Getränke", h:34, y:49, fontSize:19 }))),
      ...
      }, catalogTable(FOOD_ITEMS, tableRows(FOOD_ITEMS, "Speise"), { key:"food", title:"Speisen", h:60, y:52, fontSize:16 }))),
      base(27, {
