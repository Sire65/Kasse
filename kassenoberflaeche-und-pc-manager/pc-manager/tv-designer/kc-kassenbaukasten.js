...
(function () {
  ...
  const BAUSTEINE = [
    ...
    ['Zahlen', [
      ...
      ['kc-zahlen-scheine', 'Scheine (zwei Reihen: 50·100·200 / 5·10·20)', { seite: 'zahlen', felder: [6, 2], farbe: '#1e6848' }],
      /* 08.09.2026 - Zahlen-Seite nach Entwurf v4 mit dem Betreiber: Scheine und Münzen getrennt,
         Korrekturfeld (Zurück bis 10x, Löschen), Berechnung mit Positionszeile, Bon wie im
         Ausdruck mit Scrollbalken, eine Tastenzeile mit Symbolen. */
      ['kc-zahlen-muenzen', 'Münzen (eine Reihe, Wert darunter)', { seite: 'zahlen', felder: [6, 1], farbe: '#2c5f8a' }],
      ['kc-zahlen-korrektur', 'Zurück (letzte Eingabe) · Löschen', { seite: 'zahlen', felder: [2, 4], farbe: '#0c1726' }],
      ['kc-berechnung', 'Berechnung: Positionen · Zu zahlen · Gegeben · Rückgeld', { seite: 'zahlen', felder: [6, 2], farbe: '#8a2c2c' }],
      ['kc-beleg', 'Bon wie im Ausdruck (scrollt)', { seite: 'zahlen', felder: [6, 5], farbe: '#f5f5f5' }],
      ['kc-zahlen-tasten', 'Tastenzeile: ← · Druck · Trinkgeld · Aufrunden · Stimmt so · BAR+QR · Karte · Konto', { seite: 'zahlen', felder: [12, 1], farbe: '#374151' }],
      ...
      ['kc-zahlen-arten', 'Zahlungsarten (Bar, EC, Konto)', { seite: 'beide', /* 07.09.: auch auf Seite 1, damit BAR ohne Umweg über die Zahlen-Seite erreichbar bleibt */ felder: [3, 2], farbe: '#1e6848' }],
    ...
    ['Sondertasten', [
      ...
      /* 08.09.2026 (Betreiber): "über der Rückgeld-Taste eine schmale Knopfzeile: Training mit LED,
         Stoßzeiten mit LED, Team". Eine halbe Rasterzeile gibt es nicht - deshalb ein Block, der
         die Statuszeile (44 px) oben führt und darunter Rückgeld-Taste links + Sondertasten rechts. */
      ['kc-bedienblock', 'Bedienblock: Statuszeile · Rückgeld · Sondertasten', { seite: 'kasse', felder: [6, 2], farbe: '#4e2d4e' }],
    ]],
    ['Frei beschriften', [
