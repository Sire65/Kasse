...
(function (global) {
  ...
  function starten() {
    ...
    // 10.09.2026 (Betreiber: "die vielen einzelnen Wege, dasselbe zu tun, zusammenlegen"):
    // die ausfuehrliche Diagnose (Geschwindigkeitsmessung je Verbindungsart) gab es bisher
    // nur ueber einen Klick auf eine der LEDs oben - von dieser Seite aus, wo man sowieso
    // schon nach dem Verbindungsstatus sucht, war sie nicht erreichbar. Ruft bewusst nur die
    // bestehende, bereits vorhandene Funktion auf - nichts wird verschoben oder neu gebaut.
    el('vbDiagnoseOeffnen')?.addEventListener('click', () => global.KCVerbindungsdiagnose?.oeffne?.());
