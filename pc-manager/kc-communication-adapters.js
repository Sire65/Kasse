(function(global){
  ...
  const DEFINITIONS={
    ...
    'kc-money-butler':{displayName:'KC Money Butler',events:{report_available:{required:['personId','reportTitle'],recipient:'person'},cash_transfer_ready:{required:['registerId','amount'],recipient:'central'}}},
